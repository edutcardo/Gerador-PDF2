...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    <p>NEO MARINGÁ ENGENHARIA ELÉTRICA LTDA, pessoa jurídica devidamente inscrita no CNPJ sob o n.º 12.345.678/0001-90, com sede à Rua Exemplo, 123, na cidade de Maringá/PR - CEP 87.000-000, neste ato representada por seu representante legal, doravante denominada CONTRATANTE.</p>
    <p>WILLIAM DE AZEVEDO, brasileiro, portador do RG n.º 8397325-0 SESP/PR, inscrito no CPF n.º 009.425.209-20, residente e domiciliado na Rua Pioneiro Alcides de Araújo Vargas, n.º 219, Vila Esperança, na cidade de Maringá/PR - CEP: 87.020-620, correio eletrônico: willazevedo@gmail.com, contato: (44) 9-9951-4331, doravante denominada CONTRATANTE.</p>
    <p>Considerando que:</p>
    <p>1. A Palladium (Distribuidora) é responsável pelo fornecimento de equipamentos e materiais necessários para a instalação dos equipamentos solares fotovoltaicos.</p>
    <p>2. A Néo Maringá (Contratada) é responsável pala instalação, manutenção e suporte técnico dos equipamentos solares fotovoltaicos comercializados.</p>
    <p>3. O cliente (Contratante) que realiza a compra e a contratação dos serviços de instalação de equipamentos solares fotovoltaicos em sua propriedade.</p>
    ...
    <p>1.1. O presente contrato tem como objeto a venda, execução e implantação pela CONTRATADA de 01 (um) gerador fotovoltaico ON GRID conectado à rede pela CONTRATADA, com potência operacional estimada de 9,945 kWp, na Rua Pioneiro Alcides de Araújo Vargas, n.º 219, Vila Esperança, na cidade de Maringá/PR - CEP: 87.020-620, conforme condições, quantidades e procedimentos estabelecidos neste Instrumento.</p>
    <p>1.2. A contratação inclui:</p>
    <ul>
        <li>a) elaboração de Projeto Solar Fotovoltaico;</li>
        <li>b) fornecimento de todos os materiais, equipamentos e mão de obra necessários para a instalação do sistema de geração de energia fotovoltaica contratado;</li>
        <li>c) aprovação e conexão à rede de distribuição de energia;</li>
        <li>d) 1 (um) ano de seguro contra furto qualificado, danos elétricos e climáticos;</li>
        <li>e) o escoamento da energia pela CONTRATADA, caso o sistema adquirido tenha sido projetado para a geração compartilhada.</li>
    </ul>
    ...
    <p><strong>Cláusula 2ª – Das especificações técnicas dos produtos</strong></p>
    <p>2.1. Com base nas informações fornecidas pelo CONTRATANTE, cálculos foram realizados pelo setor de engenharia da CONTRATADA, cujo sistema de geração solar fotovoltaico proposto para o endereço informado é composto dos seguintes equipamentos:</p>
    <p>2.2. Não estão inclusos custos adicionais com obras de rede pela Concessionária local.</p>
    <p>2.3. O painel fotovoltaico, inversor e demais componentes aplicáveis são aprovados pelo Programa Brasileiro de Etiquetagem (PBE), coordenado pelo Inmetro.</p>
    <p>2.4. Os equipamentos são instalados de acordo com as orientações dos fabricantes e regulamentações fornecidas pela Agência Nacional de Energia Elétrica (ANEEL).</p>
    <p><strong>Cláusula 3ª – Dos critérios para substituição de produtos</strong></p>
    <p>3.1. Todo material e/ou equipamento empregado na execução dos serviços será novo e de primeira qualidade.</p>
    <p>3.2. Na eventual falta do produto especificado na Proposta Comercial, a CONTRATADA poderá realizar a substituição por outro de espécie, marca ou modelo similar, desde que este possua potência igual ou superior àquela do produto inicialmente proposto, sem qualquer ônus para o CONTRATANTE.</p>
    <p><strong>Cláusula 4ª – Do preço e forma de pagamento</strong></p>
    <p>4.1. Pela prestação dos serviços contratados, a CONTRATANTE pagará a CONTRATADA a quantia total de R$ 22.200,00 (vinte e dois mil e duzentos reais), cujo pagamento será realizado da seguinte forma:</p>
    <ul>
        <li>• R$ 6.660,00 (seis mil e seiscentos e sessenta reais) será pago na data da assinatura do contrato, por meio de boleto bancário, à instituição financeira SICOOB (Banco 756), Agência 4340-0, Conta Corrente 299.832-7, pertencente à Palladium Importadora de Equipamentos Ltda, inscrita no CNPJ sob o n.º 49.348.620/0001-05, chave PIX 49.348.620/0001-05.</li>
        <li>• R$ 15.540,00 (quinze mil e quinhentos e quarenta reais) será pago por meio de boleto bancário, com vencimento em 28/02/2025, à instituição financeira SICOOB (Banco 756), Agência 4340-0, Conta Corrente 299.832-7, pertencente à Palladium Importadora de Equipamentos Ltda, inscrita no CNPJ sob o n.º 49.348.620/0001-05, chave PIX 49.348.620/0001-05.</li>
    </ul>
    <p>4.1.1. Caso não ocorra a coincidência entre a data de liberação do financiamento e a data da Proposta Comercial, o CONTRATANTE, em caráter irrevogável e irretratável, autoriza a CONTRATADA a proceder ao pertinente e necessário recálculo da proposta para atualização do valor total do Contrato.</p>
    <p>4.1.2. Caso o CONTRATANTE dependa exclusivamente de financiamento bancário e este não seja aprovado pelo agente financeiro para realizar a contratação dos serviços pactuados, o contrato será rescindido de pleno direito, sem que sejam devidas quaisquer multas e/ou indenizações pela CONTRATANTE.</p>
    <p>4.2. A CONTRATANTE não vindo a efetuar o pagamento na data estipulada, fica obrigada a pagar multa de 2% (dois por cento) sobre o valor devido, bem como juros de mora de 1% (um por cento) ao mês, mais correção monetária apurada conforme variação do IGP-M no período.</p>
    <p>4.3. Em caso de desistência ou renúncia pela CONTRATANTE sem motivo justo, dentro do prazo de instalação (cláusula 4.1), será devido a CONTRATADA a título de reparação e indenização multa de 10% (dez por cento) sobre o valor do contrato.</p>
    <p>4.4. A CONTRATANTE reconhece e concorda que apenas terá a posse do Gerador Fotovoltaico após o seu pagamento integral, podendo este ser retirado pela CONTRATADA em caso de não pagamento do valor e no prazo pactuado.</p>
    <p><strong>Cláusula 5ª – Do prazo de entrega e instalação</strong></p>
    <p>5.1. O prazo para entrega dos equipamentos, instalação e início da operação do sistema solar fotovoltaico é de até 60 (sessenta) dias úteis pela CONTRATADA, contado a partir da aprovação do projeto pela concessionária COPEL.</p>
    <p>5.1.1. Havendo necessidade de aumento de carga, reforço na estrutura, reprovação/devolução do projeto pela Concessionária ou outro fator que demande maior tempo para a aprovação do projeto junto à concessionária de energia, o início da contagem do prazo previsto na cláusula 4.1. dar-se-á após a regularização efetiva deste último perante a companhia local.</p>
    <p>5.2. Serão descontados do prazo mencionado no item 5.1., dias chuvosos que não permitam a execução do serviço de instalação.</p>
    <p>5.3. Este contrato encerrar-se-á com o cumprimento das obrigações de entrega e instalação dos equipamentos solares fotovoltaicos pela CONTRATADA e de pagamento pelo CONTRATANTE do valor total do contrato pactuado.</p>
    <p>5.3.1. Após o cumprimento pelas partes das obrigações previstas na cláusula 5.3., este contrato será considerado extinto de pleno direito. Entretanto, quaisquer direitos que, expressamente ou por sua natureza, devam permanecer em vigor após o seu encerramento, não serão afetados ou limitados após a sua extinção.</p>
    <p><strong>Cláusula 6ª – Do horário e condições para prestação dos serviços</strong></p>
    <p>6.1. O serviço de instalação ocorrerá de segunda a sexta-feira, no horário das 8:00 horas às 18:00 horas, podendo ser convencionado dia e horário distinto por mútuo consentimento entre as partes.</p>
    <p>6.2. Antes da instalação dos painéis solares fotovoltaicos, o CONTRATANTE deverá realizar as adequações necessárias no seu terreno, como limpeza, remoção de vegetação e árvores que possam interferir no sombreamento sobre os painéis e/ou outros serviços indispensáveis para a obtenção de máxima eficiência energética e segurança das instalações.</p>
    <p><strong>Cláusula 7ª – Do recebimento e encerramento dos serviços</strong></p>
    <p>7.1. O encerramento dos serviços de instalação do sistema fotovoltaico será precedido de uma vistoria por parte da CONTRATADA, para que esta verifique e comprove a satisfatória execução dos serviços realizados.</p>
    <p><strong>Cláusula 8ª – Da garantia dos equipamentos</strong></p>
    <p>8.1. Os fabricantes garantem a perfeita execução dos equipamentos e periféricos comercializados ao CONTRATANTE, de acordo com os seguintes prazos:</p>
    <ul>
        <li>a) Módulo fotovoltaico - possui garantia de fábrica de 12 (doze) anos contra defeito de fabricação e de 25 (vinte e cinco) anos para performance de geração;</li>
        <li>b) Inversor – possui 10 (dez) anos de garantia contra defeito de fabricação;</li>
        <li>c) Outros componentes do gerador fotovoltaico (materiais periféricos) - possuem 01 (ano) de garantia contra defeito de fabricação.</li>
    </ul>
    <p>8.2. A contagem do período de garantia dos equipamentos pelos fabricantes inicia-se a partir da efetiva ativação do sistema solar fotovoltaico conectado à rede elétrica da concessionária. Decorrido os prazos mencionados na cláusula 8.1., o CONTRATANTE torna-se o único responsável por eventuais defeitos nos equipamentos.</p>
    <p><strong>Cláusula 9ª – Das obrigações da Contratada</strong></p>
    <p>9.1. Sem prejuízo de outras disposições deste contrato, constituem obrigações da CONTRATADA:</p>
    <ul>
        ...
        <li>l) Arcar devidamente, nos termos da legislação trabalhista, com a remuneração e demais verbas laborais devidas a seus subordinados, inclusive, encargos fiscais e previdenciários referentes às relações de trabalho;</li>
        <li>h) Arcar com todas as despesas de natureza tributária decorrentes dos serviços especificados neste contrato;</li>
        <li>i) Relatar à CONTRATANTE toda e qualquer irregularidade verificada no decorrer da prestação dos serviços;</li>
        <li>j) Guardar sigilo sobre todas as informações obtidas em decorrência do cumprimento do contrato;</li>
        <li>k) Providenciar junto ao CREA as Anotações de Responsabilidade Técnica (ART), referentes ao objeto do contrato e especialidades, nos termos das normas pertinentes.</li>
    </ul>
    <p><strong>Cláusula 10ª – Das obrigações do Contratante</strong></p>
    <p>10.1. Sem prejuízo de outras disposições deste contrato, constituem obrigações do CONTRATANTE:</p>
    <ul>
        ...
        <li>c) notificar imediatamente a CONTRATADA em caso de suspeitas ou problemas relacionados à geração de energia solar fotovoltaica;</li>
        <li>d) realizar a manutenção preventiva e executar limpezas periódicas dos sistemas fotovoltaicos instalados (recomenda-se realizar de três a quatro limpezas dos painéis por ano), uma vez que a falta dessas manutenções pode resultar em perda de desempenho do sistema e, consequentemente, na redução da produção de energia;</li>
        ...
        <li>g) facilitar o acesso dos trabalhadores da CONTRATADA ao local da obra, caso seja necessário;</li>
        <li>h) garantir a segurança dos trabalhadores da CONTRATADA, mantendo animais de estimação presos em local adequado durante a instalação dos equipamentos solares fotovoltaicos;</li>
        <li>i) afastar outras condições que estejam sob seu controle e que possam trazer riscos à segurança e saúde dos trabalhadores envolvidos na execução dos serviços;</li>
        <li>j) retirar do local de instalação quaisquer objetos de decoração ou aparelhos sensíveis que possam sofrer dano caso;</li>
        <li>k) notificar a CONTRATADA, por escrito, da ocorrência de eventuais imperfeições, falhas ou irregularidades constatadas no curso da execução dos serviços;</li>
        <li>l) realizar a segurança e preservação do sistema solar fotovoltaico, após a instalação;</li>
        <li>m) realizar a manutenção preventiva do sistema fotovoltaico e da estrutura de sustentação, seguindo as normas de engenharia durante toda a vida útil do sistema de geração, após a conclusão da instalação.</li>
    </ul>
    <p><strong>Cláusula 11ª – Da proteção de dados pessoais (LGPD)</strong></p>
    <p>11.1. Em observação às determinações constantes da Lei n.º 13.709/18 – Lei Geral de Proteção de Dados (LGPD) -, a CONTRATADA se compromete a proteger os direitos fundamentais de liberdade e de privacidade e o livre desenvolvimento da personalidade da pessoa natural, relativos ao tratamento de dados pessoais, inclusive nos meios digitais.</p>
    <p>11.2. A coleta e o tratamento de dados pessoais pela CONTRATADA ocorrerá quando estritamente necessário para a prestação dos serviços objeto deste contrato ou nas demais hipóteses, previstas nos arts. 7º e/ou 11 da Lei n.º 13.709/2018 e, em hipótese alguma, poderão ser compartilhados ou utilizados para outros fins.</p>
    <p>11.3. Em caso de necessidade de coleta de dados pessoais indispensáveis à prestação do serviço, esta será realizada mediante prévia aprovação da CONTRATANTE, responsabilizando-se a CONTRATADA por obter o consentimento do titular, salvo nos casos em que opere outra hipótese legal de tratamento.</p>
    <p>11.4. A CONTRATADA se compromete a responder todos os questionamentos feitos pela CONTRATANTE que envolvam dados pessoais repassados e a LGPD, no prazo de 5 (cinco) dias úteis, sem prejuízos dos demais deveres ajustados neste instrumento.</p>
    <p>11.5. A CONTRATADA deverá comunicar imediatamente a CONTRATANTE a ocorrência de qualquer incidente que implique violação ou risco de violação de dados pessoais, devendo adotar todas as medidas cabíveis, inclusive, técnicas para minimizar ou cessar o incidente com a maior brevidade possível.</p>
    <p>11.6. Encerrada a vigência do contrato ou não havendo mais necessidade de utilização dos dados pessoais, a CONTRATADA interromperá o tratamento dos dados pessoais disponibilizados pela CONTRATANTE e, em no máximo 30 (trinta) dias, eliminará todos os dados e cópias porventura existentes (formato digital ou físico), salvo quando tenha que manter os dados para cumprimento de obrigação legal ou outra hipótese prevista em lei.</p>
    <p><strong>Cláusula 12ª – Normas da contratada</strong></p>
    <p>12.1. A CONTRATADA observará todas as exigências legais federais, estaduais e municipais relativas à segurança, higiene e medicina do trabalho; ao meio ambiente e aos requisitos sociais, está nos seguintes requisitos: trabalho infantil, trabalho forçado, saúde e segurança, liberdade de associação e direito à negociação coletiva, discriminação, práticas disciplinares, horários de trabalho e remuneração.</p>
    <p><strong>Cláusula 13ª – Do caso fortuito e da força maior</strong></p>
    <p>13.1. As obrigações do presente contrato suspender-se-ão sempre que ocorrerem circunstâncias alheias à vontade, controle e ação das partes, causadas por motivo de força maior ou caso fortuito, na forma do Código Civil, desde que sua ocorrência seja alegada e comprovada no prazo de 48 (quarenta e oito) horas.</p>
    <p>13.2. Serão considerados casos fortuitos ou de força maior, para efeito de rescisão contratual unilateral ou não aplicação de multas, os inadimplementos decorrentes das situações a seguir, quando vierem a afetar a realização da entrega do objeto do contrato no local indicado:</p>
    <ul>
        ...
        <li>f) Eventuais atrasos decorrentes de dificuldades técnicas que venham a requerer a modificação do(s)Projeto(s) e Especificações, desde que exigidas pela engenharia ou órgão oficiais; e</li>
...
';
    ...
    function renderParagraph($pdf, $text, $width, $lineHeight, $x, $y) {
        // Fragmentar o texto em palavras
        $words = preg_split('/\s+/', $text);
    
        $currentLine = '';
        $isBold = false;  // Controle de formatação de negrito
    
        foreach ($words as $index => $word) {
            // Verificar se a palavra deve ser negrito
            if (preg_match('/^[A-ZÀ-Ú]{2,}$/u', $word)) {
            ...
            if ($pdf->GetStringWidth(trim($testLine)) > $width) {
                ...
                $pdf->MultiCell($width, $lineHeight, trim($currentLine), 0, 'J', false, 1, $x, $y);
                $y += $lineHeight;
        ...
        // Renderiza a última linha, alinhada à esquerda
        if (trim($currentLine) !== '') {
            $pdf->SetFont('helvetica', $isBold ? 'B' : '', 12);  // Verifica o estado de negrito
            $pdf->MultiCell($width, $lineHeight, trim($currentLine), 0, 'L', false, 1, $x, $y);
            $y += $lineHeight;
        }
